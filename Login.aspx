<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="_6thsem_project.User.Login" %>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div class="btn-box">
                            ...
                            <span class="pl-3 text-info">New User? <a href="Registartion.aspx" class="badge badge-info">Register Here...</a></span>
                        </div>
                    </div>
                </div>
            </div>
