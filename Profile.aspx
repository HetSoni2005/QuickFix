<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="_6thsem_project.User.Profile" %>
                                ...
                                <div class="d-flex justify-content-start">
                                    <div class="image-container">
                                        ...
                                        <div class="middle pt-2">
                                            <a href="Registartion.aspx?id=<%Response.Write(Session["userId"]);%>" class="btn btn-warning">
                                    ...
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link  text-info" id="basicInfo-tab" data-toggle="tab" href="#basicInfo" role="tab"
                                                aria-controls="basicInfo" aria-selected="false"><i class=" fa fa-clock-o mr-2"></i>Basic Info</a>
                                        </li>
                                        <li class="nav-item">
                                                ...
                                                <ItemTemplate>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 col-6">
                                                            <asp:Literal ID="ltFullName" runat="server" Text='<%# Eval("Name") %>'></asp:Literal>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 col-6">
                                                            <asp:Literal ID="ltUsername" runat="server" Text='<%# Eval("Username") %>'></asp:Literal>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 col-6">
                                                            <asp:Literal ID="ltMobile" runat="server" Text='<%# Eval("Mobile") %>'></asp:Literal>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div class="row">
                                                ...
                                                <ItemTemplate>
                                                    <div class="container">
                                                        <div class="row pt-1 pb-1" style="background-color: lightgray">
                                                            <div class="col-4">
                                                                <span class="badge badge-pill badge-dark text-white"><%# Eval("SrNo").ToString() %>
                                                                </span>
                                                        ...
                                                        <asp:Repeater ID="rOrders" runat="server">
                                                            <HeaderTemplate>
                                                                <table class="table dataTable-export table-responsive-sm table-bordered table-hover">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Price" runat="server" Text='<%#string.IsNullOrEmpty (Eval("Price").ToString()) ? "": "₹" + Eval("Price") %>'></asp:Label>
                                                                    </td>
                                                                    <td>
