...
namespace _6thsem_project.Admin
{
    public partial class Report : System.Web.UI.Page
    {
        ...
        private void getReporData(DateTime fromDate,DateTime toDate)
        {
            double grandTotal = 0;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('FromDate cannot be greater than current date!');</script>");
            }
            else
            {
                getReporData(fromDate, toDate);
            }
        }
    }
}