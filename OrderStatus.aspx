<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="_6thsem_project.Admin.OrderStatus" %>
                                                    ...
                                                    <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("Status") %> ' CssClass='<%#Eval("Status").ToString()  == "Delivered" ? "badge badge-success" : "badge badge-warning" %>'>
                                                                    </asp:Label>
                                                                </td>
                                                                <td><%#Eval("Name") %></td>
