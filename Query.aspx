<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Query.aspx.cs" Inherits="_6thsem_project.User.Query" %>
            ...
            <div class="col-md-6">
                <div class="form_container">
                    ...
                    <div>
                       ...
                       <asp:TextBox ID="txtMsg" runat="server"  TextMode="MultiLine" CssClass="form-control" placeholder="Enter Your Query"></asp:TextBox>
                    </div>
                    <div class="btn_box">
