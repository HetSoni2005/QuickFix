<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="_6thsem_project.User.Cart" %>
            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <img width="60" src="<%# Utils.GetImageUrl(Eval("ImageUrl")) %>" alt="no image" />
                        </td>
                        ...
                        <td>
                            <div class=" product__details__option">
                                <div class="quantity">
                                    <div class="pro-qty">
                                        <asp:TextBox runat="server" ID="txtQuantity" TextMode="Number" Text='<%# Eval("Qty") %>'>
                                        </asp:TextBox>
                                        <asp:RegularExpressionValidator ID="revQuantity" Font-Size="Small" runat="server"
                                            ErrorMessage="*" ForeColor="Red" ValidationExpression="[1-9][0-9]*" ControlToValidate="txtQuantity"
                        ...
                        <td>
                            <asp:LinkButton ID="lbDelete" Text="Remove" CommandName="remove" CommandArgument='<%# Eval("ProductId") %>'
                                runat="server" OnClientClick="return confirm('Do you want to remove this item from the cart?');">
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Menu.aspx" class="btn btn-info">
                                <i class="fa fa-arrow-circle-left mr-2"> </i>Countinue Shopping
                            </a>
                        </td>
                        <td>
